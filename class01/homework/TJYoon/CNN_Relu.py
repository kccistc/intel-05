...
model.add(tf.keras.layers.Conv2D(128,(2,2),2, activation = 'relu', input_shape= (28,28,1)))
model.add(tf.keras.layers.Conv2D(32,(2,2), activation = 'relu', input_shape= (28,28,1)))
model.add(tf.keras.layers.Conv2D(64,(2,2), activation = 'relu', input_shape= (28,28,1)))
model.add(tf.keras.layers.Conv2D(128,(2,2),2, activation = 'relu', input_shape= (28,28,1)))
...
with open('fashion_mnist_noBatch_Relu', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

model.summary()
model.save('fashion_mnist_noBatch_Relu.h5')

...
model.add(keras.layers.Conv2D(128,(2,2),2,activation='relu'))
model.add(keras.layers.Conv2D(32,(2,2),activation='relu'))
model.add(keras.layers.Conv2D(64,(2,2),activation='relu'))
model.add(keras.layers.Conv2D(128,(2,2),2,activation='relu'))
# ANN
model.add(keras.layers.Flatten())
model.add(keras.layers.Dense(128, activation='sigmoid')) # relu로 바꿔도 상관없음
...
with open('history_CNN_fashion_mnist_relu', 'wb') as file_pi: # wb = write binary
    pickle.dump(history.history, file_pi)

model.summary()
model.save('CNN_fashion_mnist_relu.h5')
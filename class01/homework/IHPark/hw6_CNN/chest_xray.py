...
# the function ImageDataGenerator augments your image by iteration through image as your CNN is getting ready to process that image
...
history = model.fit()
with open('history_chest_xray', 'wb') as file_pi:
